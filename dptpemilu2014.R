library(XML)
urlDPT="https://data.kpu.go.id/ss8.php?cmd=select&grandparent=0&parent=0"

#Untuk Data Nasional
dptpemilu2014nas=readLines(urlDPT)
dptpemilu2014nas=readHTMLTable(dptpemilu2014nas)
dptpemilu2014nas=(dptpemilu2014nas[[1]])

#rapih-rapih
{
colnames(dptpemilu2014nas)=c("Kabupaten/Kota",
              "Jml. TPS",
              "L",
              "P",
              "Nihil (%)",
...
dptpemilu2014nas=dptpemilu2014nas[-c(1:2),]
...
urlDPTkab=paste0("https://data.kpu.go.id/ss8.php?cmd=select&grandparent=0&parent=",idprov)
lapply(idprov, readLines)
dptpemilu2014kab=readLines(urlDPT)
